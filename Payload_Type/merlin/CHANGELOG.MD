...
- Fixed [Issue 25](https://github.com/MythicAgents/merlin/issues/25) - Updated docker image and builder to compile DLL for 386

## 2.4.1 - 2024-10-14

### Added

- Added freebsd, openbsd, and solaris to existing commands

## 2.4.0 - 2024-10-14

### Added

- Added `memfd` command documentation page

### Fixed

- Fixed [Issue 20](https://github.com/MythicAgents/merlin/issues/20) by explicitly setting the transforms (e.g., AES) at build time with Go's `ldflags`
  - Check if `aes256_hmac` is provided when using the http C2 profile

### Changed

- Upgraded github.com/fatih/color v1.16.0 => v1.17.1
- Upgraded github.com/Ne0nd0g/merlin-agent/v2 v2.4.1 => v2.4.2
- Upgraded github.com/MythicMeta/MythicContainer v1.4.4 => v1.4.6
- Upgraded Docker image from ne0nd0g/merlin-base:v1.7.0 to v1.8.0
...
- Upgraded github.com/MythicMeta/MythicContainer v1.3.13 => v1.4.4 to support Mythic v3.3
